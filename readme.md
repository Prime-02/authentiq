...
**Backend API Docs:** [https://sans-242869c0.fastapicloud.dev/docs](https://sans-242869c0.fastapicloud.dev/docs) *(view only)*  
...
*Built with ❤️ by Utojiuba Chidera Gospel — Internship Project, Maxfront Technologies Limited*