...
const Cart = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row p-6 md:p-12 w-full md:w-[90%] justify-between mx-auto gap-6 h-auto min-h-screen">
        ...
        <ul className="space-y-6">
          {groupedCart.length > 0 ? (
            groupedCart.map((item, index) => (
              ...
              >
                {/* Product Image */}
                <div className="w-full md:w-1/3 h-56 md:h-72 flex items-center justify-center card rounded-lg overflow-hidden bg-gray-100">
                  <DynamicImage
      ...
      <section className="w-full md:w-1/3 p-6 rounded-2xl shadow-xl h-fit">
